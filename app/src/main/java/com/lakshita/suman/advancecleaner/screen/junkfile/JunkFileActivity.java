package com.lakshita.suman.advancecleaner.screen.junkfile;
...
import com.lakshita.suman.advancecleaner.adapter.CleanAdapter;
import com.lakshita.suman.advancecleaner.model.ChildItem;
import com.lakshita.suman.advancecleaner.model.GroupItem;
...
import com.lakshita.suman.advancecleaner.widget.AnimatedExpandableListView;
import com.lakshita.suman.advancecleaner.widget.CleanJunkFileView;
import com.lakshita.suman.advancecleaner.widget.RotateLoading;
...
public class JunkFileActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.O_MR1) {
            lnSystemCache.setVisibility(View.GONE);
        } else {
            lnSystemCache.setVisibility(View.VISIBLE);
        }
    }
