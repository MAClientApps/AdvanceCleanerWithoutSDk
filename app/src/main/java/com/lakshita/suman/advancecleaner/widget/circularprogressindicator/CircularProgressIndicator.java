package com.lakshita.suman.advancecleaner.widget.circularprogressindicator;
...
public class CircularProgressIndicator extends View {
    ...
    private static final int DEFAULT_ANIMATION_DURATION = 3_000;
    ...
    private void drawProgress(Canvas canvas) {
        canvas.drawArc(circleBounds, startAngle + 16, sweepAngle, false, progressPaint);
    }
    ...
    public void setGradient(@GradientType int type, @ColorInt int endColor) {
        ...
        switch (type) {
            ...
            case RADIAL_GRADIENT:
                ...
                break;
            case SWEEP_GRADIENT:
                gradient = new SweepGradient(cx, cy, new int[]{endColor, startColor}, null);
                break;
        }
