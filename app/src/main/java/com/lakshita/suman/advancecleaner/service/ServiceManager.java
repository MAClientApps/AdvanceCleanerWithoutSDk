...
import com.lakshita.suman.advancecleaner.receiver.AlarmReceiver;
import com.lakshita.suman.advancecleaner.receiver.BatteryStatusReceiver;
import com.lakshita.suman.advancecleaner.receiver.PackageRecerver;
...
import com.lakshita.suman.advancecleaner.screen.smartCharger.SmartChargerBoostActivity;
import com.lakshita.suman.advancecleaner.utils.AlarmUtils;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (id) {
                ...
                case R.id.ll_cleanup:
                    if (CleanMasterApp.getInstance().getTopActivity() instanceof JunkFileActivity) {
                        nothingAction = true;
                    }
                    mFunction = Config.FUNCTION.JUNK_FILES;
                    break;
                case R.id.ll_boost:
                    if (CleanMasterApp.getInstance().getTopActivity() instanceof PhoneBoostActivity) {
                        nothingAction = true;
                    }
                ...
                case R.id.tv_clean_spam:
                    if (CleanMasterApp.getInstance().getTopActivity() instanceof NotificationCleanActivity) {
                        nothingAction = true;
                    }
