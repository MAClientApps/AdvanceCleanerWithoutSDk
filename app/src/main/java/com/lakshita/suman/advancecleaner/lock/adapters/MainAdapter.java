package com.lakshita.suman.advancecleaner.lock.adapters;
...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder> {
    ...
    public void changeItemLockStatus(@NonNull SwitchCompat checkBox, @NonNull CommLockInfo info, int position) {
