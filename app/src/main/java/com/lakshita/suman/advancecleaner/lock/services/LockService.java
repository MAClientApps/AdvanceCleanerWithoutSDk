package com.lakshita.suman.advancecleaner.lock.services;
...
import com.lakshita.suman.advancecleaner.lock.db.CommLockInfoManager;
import com.lakshita.suman.advancecleaner.lock.receiver.LockRestarterBroadcastReceiver;
import com.lakshita.suman.advancecleaner.lock.utils.NotificationUtil;
...
//                }
    ...
    private void passwordLock(String packageName) {
        ...
        Intent intent = new Intent(this, GestureUnlockLockActivity.class);
    ...
    public void onTaskRemoved(Intent rootIntent) {
        ...
        if (lockState) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                restartPendingIntent = PendingIntent.getService(getApplicationContext(), 1495, restartServiceTask, PendingIntent.FLAG_ONE_SHOT | PendingIntent.FLAG_IMMUTABLE);
            } else {
                restartPendingIntent = PendingIntent.getService(getApplicationContext(), 1495, restartServiceTask, PendingIntent.FLAG_ONE_SHOT);
            }
