package com.lakshita.suman.advancecleaner.screen.antivirus;
...
import com.lakshita.suman.advancecleaner.data.TaskScanAntivirus;
import com.lakshita.suman.advancecleaner.model.TaskInfo;
import com.lakshita.suman.advancecleaner.screen.BaseActivity;
import com.lakshita.suman.advancecleaner.screen.antivirus.fragment.ListAppDangerousFragment;
import com.lakshita.suman.advancecleaner.screen.antivirus.fragment.ListAppVirusFragment;
import com.lakshita.suman.advancecleaner.utils.Config;
import com.lakshita.suman.advancecleaner.widget.AntivirusScanView;
...
public class AntivirusActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        isCanback = false;
        taskScanAntivirus = new TaskScanAntivirus(this, 200, new TaskScanAntivirus.OnTaskListListener() {
            @Override
        ...
        taskScanAntivirus.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
