...
public class ServiceNotificationManager {
    ...
    public void showNotificationChargeConnected() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            resultPendingIntent = PendingIntent.getActivity(context, NOTIFICATION_ID_BATTERY_CONNECTED, resultIntent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        } else {
            resultPendingIntent = PendingIntent.getActivity(context, NOTIFICATION_ID_BATTERY_CONNECTED, resultIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        }
